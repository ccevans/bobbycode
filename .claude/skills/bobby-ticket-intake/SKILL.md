...
- **Never leave placeholder text** — `[What is this ticket about?]`, `[First criterion]`, `_None yet._` (unless there are genuinely no open questions) are failures.
...
- **Do not move the ticket to planning** — leave it in `backlog`. The engineer decides when to advance it.

## Anti-Patterns

<!-- bobby learn bobby-ticket-intake adds entries below this line -->
