...
1. Save benchmark results to `.bobby/benchmarks/`
2. If this is the first run, also save as `baseline.json`
...
4. If regressions found: `bobby ticket create -t "PERF: {page} load time regressed {%}" --type bug -p high`
5. If you discovered a pattern: `bobby learn bobby-performance "pattern" "description"`
