...
Then sequentially:
4. **Resume check** — If `.bobby/tickets/{ID}*/progress.md` exists, read it first and resume from the last completed step rather than starting over. Delete `progress.md` after `bobby ticket move {ID} review`.
