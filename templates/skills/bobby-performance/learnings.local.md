# Performance — This Project's Learnings

**This file is yours.** Bobby seeds it once and never writes it again — not on
re-scaffold, not on upgrade. `bobby learn bobby-performance "pattern" "description"` adds here.
...
## Anti-Patterns
<!-- bobby learn bobby-performance "pattern" "description" to add entries -->
