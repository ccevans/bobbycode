...
export class ChatManager {
  ...
  async sendMessage(chatId, message) {
    ...
    // Call runChat — plan (read-only) mode with --resume on subsequent turns.
    await this.orchestrator.runChat(meta.workspaceId, {
  ...
  async commitPlan(chatId) {
    ...
    await this.orchestrator.commitChat(meta.workspaceId, {
      resume: ws.chatId || undefined,
    });
