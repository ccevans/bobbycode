...
import { resolveRepoPath, resolveProductDir } from '../config.js';
...
export class Orchestrator {
  ...
  _launch(ws, { agent, prompt, worktreePath, ticketIds }) {
    ...
    const handle = this._runExecutor({
      ...
      permissionMode: resolvePermissionMode(this.config, kind),
  ...
  _promptContext(ws, { epicData } = {}) {
    return {
      ...
      productDir: resolveProductDir(this.repoRoot, this.config),
      epicData,
