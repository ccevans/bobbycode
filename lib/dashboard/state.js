 ...
 */
export const RUN_STATUSES = ['completed', 'failed', 'stopped'];
 ...
 */
export function runOutcome({ exitCode, signal } = {}) {
...
export function newRun({
  ...
  return {
    ...
    status: runOutcome({ exitCode, signal }),
 ...
 */
export function newWorkspace({ id, ticketId, worktreePath, branch, agent, pipeline = 'default', kind = 'worktree' }) {
