...
export function newWorkspace({
  ...
  repoRoot = null, lockFile = null, ticketsDir = null, sessionsDir = null,
}) {
 ...
 */
export function newRepoRun({ id, agent, pipeline = 'default', ticketsDir = null, sessionsDir = null }) {
  return newWorkspace({
    id,
    ticketId: null,
    worktreePath: null,
