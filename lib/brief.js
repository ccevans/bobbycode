...
const DEFINE_STAGES = ['define-brief', 'define-personas', 'define-journeys', 'define-data-model', 'define-architecture', 'define-features', 'define-mockups', 'define-blueprint'];
...
// `security` sits between building and reviewing (the secure workflow order).
const IN_FLIGHT_STAGES = ['planning', ...DESIGN_STAGES, 'building', 'security', 'reviewing', 'testing', 'shipping'];
// Lower = further along; finish work in progress before starting new.
const STAGE_RANK = {
  shipping: 0, testing: 1, reviewing: 2, security: 3, building: 4,
  'design-spec': 5, 'design-mockup': 6, 'design-analyze': 7, 'design-research': 8,
  planning: 9,
};
...
// a ticket parked in design-mockup resumes design-mockup. `security` hands to
// review: only a ticket on `secure` ever parks there, and the step after
// security is review either way.
const NEXT_AGENT = {
  planning: 'build', building: 'review', security: 'review', reviewing: 'test', testing: 'ship', shipping: 'ship',
