...
export const STAGE_ORDER = {
  ...
  planning: 9,
  'define-features': 10, 'define-journeys': 11, 'define-personas': 12, 'define-brief': 13,
  backlog: 14, blocked: 15,
};
...
export function getFeatureTickets(ticketsDir, epicId) {
  ...
  children.sort((a, b) => {
    const stageDiff = (STAGE_ORDER[a.stage] ?? 15) - (STAGE_ORDER[b.stage] ?? 15);
