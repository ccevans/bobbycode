...
const STAGE_ORDER = { done: 0, shipping: 1, testing: 2, reviewing: 3, security: 4, building: 5, planning: 6, backlog: 7, blocked: 8 };
 ...
 */
export function listTickets(ticketsDir, { stage, blocked, epic, area, priority, type, staleDays, sort } = {}) {
 ...
 */
export function createTicket(ticketsDir, { prefix, title, type = 'feature', priority = 'medium', author = 'unknown', area = '', parent = null, services = null, workflow = null, description = '', criteria = [] }) {
