...
export const STAGE_ORDER = {
  done: 0, shipping: 1, testing: 2, reviewing: 3, building: 4,
  'design-spec': 5, 'design-mockup': 6, 'design-analyze': 7, 'design-research': 8,
  planning: 9,
  'define-blueprint': 10, 'define-features': 11, 'define-journeys': 12, 'define-personas': 13, 'define-brief': 14,
  backlog: 15, blocked: 16,
};
 ...
 */
export function createTicket(ticketsDir, { prefix, title, type = 'feature', priority = 'medium', author = 'unknown', area = '', parent = null, services = null, workflow = null, description = '', criteria = [], feature = null, persona = null }) {
...
export function getFeatureTickets(ticketsDir, epicId) {
  ...
  children.sort((a, b) => {
    const stageDiff = (STAGE_ORDER[a.stage] ?? 16) - (STAGE_ORDER[b.stage] ?? 16);
