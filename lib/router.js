...
export const CAPABILITIES = [
  ...
  { when: 'define the product / write the brief / personas / user journeys / feature map / what should v1 be / scope the MVP', do: 'bobby run define <epicId>', note: 'brief → personas → journeys → feature map → blueprint, a human gate at each stage; then bobby-plan decomposes traceably' },
