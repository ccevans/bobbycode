...
export const AGENT_REGISTRY = {
  ...
  'design-research': {
    ...
    promptSteps: [
      'Ask the user for references FIRST — their references are THE SET; never pad it with your own picks.',
  ...
  design: {
    label: 'Bobby Design',
    agentName: 'bobby-design',
    cowork: true,
    promptHeader: 'Run the bobby-design agent to design or redesign an interface.',
    promptSteps: [
      'Follow the instructions in `{agentsPath}/bobby-design.md`.',
      'Run the design process: brief, reference remix, style tiles, tokens, build, critique.',
      'Stop at two gates only — the style tile pick and the final critique. The user reacts; you design.',
      'Run the anti-generic checklist and answer the distinctiveness question in writing before shipping.',
      'Record the chosen direction, its signature move, and the token set.',
    ],
  },
  pm: {
    label: 'Bobby PM',
