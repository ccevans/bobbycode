...
export const AGENT_REGISTRY = {
  ...
  claude: {
    label: 'Bobby Claude',
    agentName: 'bobby-claude',
    freeform: true,
    promptHeader: 'Run the bobby-claude agent to analyze and improve this project's CLAUDE.md.',
    promptSteps: [
      'Follow the instructions in `{agentsPath}/bobby-claude.md`.',
      'Read the full source tree of the target repo — no questions until you've read everything.',
      'Detect canonical patterns and contradictions with exact file counts.',
      'Rewrite or create CLAUDE.md with accurate commands, architecture notes, code quality rules, and pitfalls.',
      'Record resolved contradictions in `.bobby/decisions.yaml`.',
    ],
  },
  intake: {
  ...
  retro: {
    label: 'Bobby Retro',
    agentName: 'bobby-retro',
    freeform: true,
    promptHeader: 'Run the bobby-retro agent to generate a retrospective.',
    promptSteps: [
      'Follow the instructions in `{agentsPath}/bobby-retro.md`.',
      'Read all `.bobby/tickets/*/ticket.md` frontmatter upfront to determine scope.',
      'For tickets in scope: read plan.md, review.md, test-cases.md, and matching session logs.',
      'Reconstruct pipeline journeys, count retries, identify recurring review patterns.',
      'Draft candidate learnings — list with `bobby learn` commands but NEVER auto-run them.',
      'Write output to `.bobby/tickets/retrospectives/retro-{scope}-{timestamp}.md`.',
    ],
  },
  performance: {
