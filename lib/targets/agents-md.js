...
//     — all ahead of AGENTS.md in the list) silently shadows this target's
//     AGENTS.md. No Bobby target scaffolds any of those names (grep over
//     lib/, commands/, templates/, re-verified 2026-08-24: the only hits are
//     detection-only code in lib/detect.js and never-write comments in
//     lib/targets/copilot.js), so in a fresh Bobby scaffold AGENTS.md is the
//     first match.
