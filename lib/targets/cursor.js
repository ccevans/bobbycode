...
//
// `agents` has no native equivalent — Cursor has no user-defined subagent
// registry — so agent definitions are plain files under .cursor/agents/ that
// the generated prompts point at by path. That is how the Cline target works
// too, and it's why supportsSubagents() is false: stages run one at a time in
// the main agent instead of being dispatched to a subagent.
//
