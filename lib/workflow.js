...
export const BUILT_IN_WORKFLOWS = {
  ...
  // The mockups step (after the feature map locks, before blueprint) designs
  // the v1 screens FROM the personas/journeys; it is optional — `--no-mockups`
  // filters it via omitStage, and its gate accepts "skip".
  define: ['define-brief', 'define-personas', 'define-journeys', 'define-features', 'define-mockups', 'define-blueprint'],
