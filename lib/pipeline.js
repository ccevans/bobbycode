 ...
 */
export function buildPerformancePrompt(ticketsDir = '.bobby/tickets') {
  return `Run the bobby-performance agent for performance benchmarking.

1. Follow the instructions in \`.claude/agents/bobby-performance.md\`.
 ...
 */
export function buildWatchdogPrompt(ticketsDir = '.bobby/tickets') {
  return `Run the bobby-watchdog agent for post-deploy verification.

1. Follow the instructions in \`.claude/agents/bobby-watchdog.md\`.
 ...
 */
export function buildStrategyPrompt(ticketsDir = '.bobby/tickets') {
  return `Run the bobby-strategy agent to evaluate backlog tickets for strategic readiness.

1. Follow the instructions in \`.claude/agents/bobby-strategy.md\`.
